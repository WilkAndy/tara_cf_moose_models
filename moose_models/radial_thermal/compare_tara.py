...
moose_timesteps = ["0080", "0193", "0384", "0663"]
moosePTSUSS = [moose("radial_thermal_csv_ptsuss_" + ts + ".csv") for ts in moose_timesteps]
...
plt.savefig("../figures/radial_thermal_porepressure_fig.pdf")
...
plt.savefig("../figures/radial_thermal_temperature_fig.pdf")
...
plt.savefig("../figures/radial_thermal_displacement_fig.pdf")
...
plt.savefig("../figures/radial_thermal_sg_fig.pdf")
...
plt.savefig("../figures/radial_thermal_seff_rr_fig.pdf")
...
plt.savefig("../figures/radial_thermal_seff_tt_fig.pdf")
