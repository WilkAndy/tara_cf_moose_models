...
moose_timesteps = ["0029", "0058", "0095", "0137"]
moose_timesteps = ["0078", "0198", "0412", "0699"]
moosePTSUSS = [moose("tara_csv_ptsuss_" + ts + ".csv") for ts in moose_timesteps]
...
plt.savefig("../figures/tara_compare_porepressure_fig.pdf")
...
plt.savefig("../figures/tara_compare_temperature_fig.pdf")
...
plt.savefig("../figures/tara_compare_displacement_fig.pdf")
...
plt.savefig("../figures/tara_compare_sg_fig.pdf")
...
plt.savefig("../figures/tara_compare_seff_rr_fig.pdf")
...
plt.savefig("../figures/tara_compare_seff_tt_fig.pdf")
