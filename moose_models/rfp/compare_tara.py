...
moose_timesteps = ["0062", "0136", "0270", "1478"]
...
plt.savefig("../figures/rfp_porepressure_fig.pdf")
...
plt.savefig("../figures/rfp_temperature_fig.pdf")
...
plt.savefig("../figures/rfp_displacement_fig.pdf")
...
plt.savefig("../figures/rfp_sg_fig.pdf")
...
plt.savefig("../figures/rfp_seff_rr_fig.pdf")
...
plt.savefig("../figures/rfp_seff_tt_fig.pdf")
