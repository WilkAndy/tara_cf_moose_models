...
moose_timesteps = ["0065", "0188", "0400", "0699"]
moosePTSUSS = [moose("dynamic_por_csv_ptsuss_" + ts + ".csv") for ts in moose_timesteps]
...
plt.savefig("../../figures/dynamic_por_porepressure_fig.pdf")
...
plt.savefig("../../figures/dynamic_por_temperature_fig.pdf")
...
plt.savefig("../../figures/dynamic_por_displacement_fig.pdf")
...
plt.savefig("../../figures/dynamic_por_sg_fig.pdf")
...
plt.savefig("../../figures/dynamic_por_seff_rr_fig.pdf")
...
plt.savefig("../../figures/dynamic_por_seff_tt_fig.pdf")
