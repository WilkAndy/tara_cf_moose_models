...
#print "temp front: one hour", temperature_shock_position(one_hour, mu1_moose, mu2_moose)
#print "temp front: one day", temperature_shock_position(one_day, mu1_moose, mu2_moose)
#print "temp front: one month", temperature_shock_position(one_month, mu1_moose, mu2_moose)
#print "temp front: one year", temperature_shock_position(0.2 * five_years, mu1_moose, mu2_moose)
#print "temp front: five years", temperature_shock_position(five_years, mu1_moose, mu2_moose)
#print "sat front: one hour", saturation_shock_position(one_hour, mu1_moose, mu2_moose)
#print "sat front: one day", saturation_shock_position(one_day, mu1_moose, mu2_moose)
#print "sat front: one month", saturation_shock_position(one_month, mu1_moose, mu2_moose)
#print "sat front: one year", saturation_shock_position(0.2 * five_years, mu1_moose, mu2_moose)
#print "sat front: five years", saturation_shock_position(five_years, mu1_moose, mu2_moose)
#sys.exit(0)
