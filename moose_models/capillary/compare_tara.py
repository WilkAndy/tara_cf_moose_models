...
def moose(fn):
    try:
        ...
        data = ([d[0] for d in data], [d[11] for d in data], [d[5] for d in data], [d[6] for d in data], [d[7] for d in data], [d[8] for d in data], [d[9] for d in data])
        f.close()
    except:
        sys.stderr.write("Cannot read " + fn + ", or it contains erroneous data\n")
        sys.exit(1)
...
plt.title("Effective fluid porepressure, Pf")
plt.savefig("../figures/cap_pp_porepressure_fig.pdf")
...
plt.savefig("../figures/cap_pp_temperature_fig.pdf")
...
plt.savefig("../figures/cap_pp_displacement_fig.pdf")
...
plt.savefig("../figures/cap_pp_sg_fig.pdf")
...
plt.savefig("../figures/cap_pp_seff_rr_fig.pdf")
...
plt.savefig("../figures/cap_pp_seff_tt_fig.pdf")
